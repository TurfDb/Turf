...
public protocol Extension {
     ...
     */
    func newConnection<DatabaseCollections>(_ connection: Connection<DatabaseCollections>) -> ExtensionConnection
     ...
     */
    func install<DatabaseCollections>(using transaction: ReadWriteTransaction<DatabaseCollections>, db: SQLitePtr, existingInstallationDetails: ExistingExtensionInstallation?) throws
